...
public class PaiementAdminPendingResponse {
    ...
    public PaiementAdminPendingResponse(
            ...
            final UserSummaryResponse creePar,
    ...
    public static PaiementAdminPendingResponse fromEntity(final Paiement paiement) {
        return new PaiementAdminPendingResponse(
                paiement.getId(),
                ...
                UserSummaryResponse.fromEntity(paiement.getCreePar()),
                paiement.getStatus(),
    ...
    public UserSummaryResponse getCreePar() {
        return creePar;
    }
